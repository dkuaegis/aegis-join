...
export class ServerError extends Error {
  ...
  constructor(response: { status: number; headers: Headers; url: string; method?: string }) {
    super(`Server error! status: ${response.status} for ${response.method || 'GET'} ${response.url}`);
