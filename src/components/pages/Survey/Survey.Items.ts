...
{ id: InterestField.SECURITY_NOT_SURE, description: "분야를 아직 정하지 못 했어요" },
...
{ id: InterestField.WEB_NOT_SURE, description: "분야를 아직 정하지 못 했어요" },
...
{ id: InterestField.GAME_NOT_SURE, description: "분야를 아직 정하지 못 했어요" },
